        ...
        for row_idx in 0..n {
            let record = Value::Record(vec![
                ...
                (
                    ...
                    col_first_name.value(row_idx).into(),
                ),
                ...
                (
                    ...
                    col_occupation.value(row_idx).into(),
                ),
                ...
                (
                    ...
                    col_department.value(row_idx).into(),
                ),
                ...
                (
                    ...
                    col_description.value(row_idx).into(),
                ),
                ("notes".to_string(), col_notes.value(row_idx).into()),
                (
                    "created_at".to_string(),
                    col_created_at.value(row_idx).into(),
                ),
                (
                    "updated_at".to_string(),
                    col_updated_at.value(row_idx).into(),
                ),
                (
                    "ip_address".to_string(),
                    col_ip_address.value(row_idx).into(),
                ),
                (
                    "user_agent".to_string(),
                    col_user_agent.value(row_idx).into(),
                ),
            ]);
