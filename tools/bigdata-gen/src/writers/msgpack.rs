    ...
    for batch in chunk_iter(seed, total, cols) {
        ...
        for i in 0..n {
            ...
            let map: std::collections::BTreeMap<&str, rmpv::Value> = [
                ...
                (
                    "first_name",
                    rmpv::Value::String(col_first_name.value(i).into()),
                ),
                (
                    "last_name",
                    rmpv::Value::String(col_last_name.value(i).into()),
                ),
                ...
                (
                    "occupation",
                    rmpv::Value::String(col_occupation.value(i).into()),
                ),
                ...
                (
                    "currency",
                    rmpv::Value::String(col_currency.value(i).into()),
                ),
                (
                    "department",
                    rmpv::Value::String(col_department.value(i).into()),
                ),
                (
                    "join_date",
                    rmpv::Value::String(col_join_date.value(i).into()),
                ),
                ...
                (
                    "category",
                    rmpv::Value::String(col_category.value(i).into()),
                ),
                ("status", rmpv::Value::String(col_status.value(i).into())),
                (
                    "priority",
                    rmpv::Value::String(col_priority.value(i).into()),
                ),
                (
                    "description",
                    rmpv::Value::String(col_description.value(i).into()),
                ),
                ("notes", rmpv::Value::String(col_notes.value(i).into())),
                (
                    "created_at",
                    rmpv::Value::String(col_created_at.value(i).into()),
                ),
                (
                    "updated_at",
                    rmpv::Value::String(col_updated_at.value(i).into()),
                ),
                (
                    "ip_address",
                    rmpv::Value::String(col_ip_address.value(i).into()),
                ),
                (
                    "user_agent",
                    rmpv::Value::String(col_user_agent.value(i).into()),
                ),
            ]
            .into_iter()
            .collect();
