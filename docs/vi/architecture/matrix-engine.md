...
| Phương thức | Hành vi |
| :--- | :--- |
| `slice_rows(file_path, offset, limit)` | Đọc một khoảng dòng trả về PyArrow Table bằng cách stream và bỏ qua các batch trước offset. Với IPC/Feather dùng memory-map qua `memmap2`. |
