...
| `.br_map.bazan` | Payload Lake map Arrow IPC tại gốc: metadata file cùng vị trí row-group Parquet, block dòng NDJSON/JSONL và CSV/TSV/PSV/TXT và batch Arrow IPC/Feather (7 cột, xem đặc tả) |
