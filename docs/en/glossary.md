...
| `.br_map.bazan` | Arrow IPC lake map payload at root: file metadata plus Parquet row-group, NDJSON/JSONL and CSV/TSV/PSV/TXT row-block, and Arrow IPC/Feather batch locations (7 columns, see spec) |
