...
| `.br_map.bazan` | Arrow IPC lake map payload at root: file metadata plus Parquet row-group, NDJSON/CSV/TSV row-block, and Arrow IPC/Feather batch locations (7 columns, see spec) |
