...
| `row_groups_json` | `Utf8` | Parquet row-group, NDJSON/JSONL/JSON-array and CSV/TSV/PSV/TXT row-block, or Arrow IPC/Feather RecordBatch locations; `[]` for other formats |
